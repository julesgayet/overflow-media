    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2.5 pt-8">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-mono text-xs font-medium text-white">{c.views}</span>
  ...
  return (
    <section id="top" className="relative overflow-hidden pt-[72px]">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute right-[-12rem] top-[8rem] size-[30rem] rounded-full bg-accent/10 blur-[130px]" />
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,.028)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,.028)_1px,transparent_1px)] bg-[size:64px_64px] [mask-image:radial-gradient(ellipse_70%_55%_at_50%_25%,#000,transparent)]" />
      </div>
      ...
      <div className="container-x pb-16 pt-20 md:pb-24 md:pt-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <Reveal delay={80}>
            <h1 className="mt-7 text-balance text-[2.6rem] font-semibold leading-[1.03] tracking-[-0.03em] sm:text-6xl md:text-7xl">
          ...
          <Reveal delay={160}>
            <p className="mx-auto mt-7 max-w-2xl text-pretty text-base leading-relaxed text-mist md:text-lg">
              {site.name} découpe ton contenu long en centaines de clips verticaux, les
              diffuse via une communauté de clippeurs vérifiés, et ne facture que les vues
              réellement générées. Zéro retainer, zéro gestion manuelle.
            </p>
          </Reveal>
          ...
          <Reveal delay={320}>
            <div className="mt-9 flex flex-wrap items-center justify-center gap-x-7 gap-y-3 text-xs text-mist-2">
              ...
              <span>Paiement au CPM · sans engagement</span>
            </div>
          </Reveal>
        </div>
      </div>
